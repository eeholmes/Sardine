...
source(file.path(here::here(), "inst", "extdata", "get_satellite_data", "get_EMT_functions.R"))
library(ggplot2)
library(tidyr)
library(dplyr)
library(raster)
...
```{r}
library(tidyr)
cols <- c("date", "latitude", "longitude", "u", "v", "taux","tauy", "ektrx", "ektry")
